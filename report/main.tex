...
\begin{abstract}
    ...
    In this work, we aim to reconstruct images from their feature embeddings in a known latent space.
    ...
    %TODO add the ref for that \cite{dosovitskiyInvertingVisualRepresentations2016}
